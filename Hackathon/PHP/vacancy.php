      ...
      <header class="nav-bar">
            ...
            <?php
                if(!empty($_SESSION['admin'])){
                    ...
                    <div class="upload-query">
                        <img src="../Images/UserProfile/<?php'.$userResult["profile_image"].'">
        ...
        <div class="queries">
            <div class='query-card'>
                ...
                <div class='query'>
                    <pre>
Vacancy Open At ABC company for the post of web developer
Skills Required
 - HTML, CSS & JS
 - PHP
            ...
            <div class='query-card'>
                ...
                <div class='query'>
                    <pre>
Vacancy Open At XYZ company for the post of Mobile Application Developer
Skills Required
 - React Native
 - Node JS
